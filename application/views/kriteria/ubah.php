                            ...
                            <form method="POST" action="<?= base_url() . 'kriteria/update'; ?>">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" id="kode" name="kode" value="<?= $kriteria['kode'] ;?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="atribut" name="atribut" value="<?= $kriteria['atribut'] ;?>">
                                    </div>
                                </div>
                                <!-- /.card-body -->
